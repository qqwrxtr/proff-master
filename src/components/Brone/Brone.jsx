...
const Brone = () => {
    return (
        <section className="relative py-10 px-4 max-w-[1440px] rounded-3xl shadow-xl w-full flex justify-center flex-col items-center text-center" id="забронировать-мастера">
            {/* Title */}
            ...
            >
                ...
                {/* Content */}
                <div className="relative z-10 h-full flex flex-col justify-between items-center text-center text-white px-4 md:px-12 lg:px-20">
                    {/* Centered Text */}
                    <div className="flex-grow flex flex-col justify-center">
                        <p className="xs:text-xl text-2xl md:text-3xl xl:text-4xl font-bold leading-relaxed max-w-7xl mx-auto -mb-20 lg:-mb-44">
